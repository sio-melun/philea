...
class Domaine
{
    ...
    /**
    * @ORM\OneToMany(targetEntity="Cnes\PhileaBundle\Entity\Projet", mappedBy="domaine")
    */
    private $projets;
     ...
     * Add projets
     *
     * @param \Cnes\PhileaBundle\Entity\Projet $projets
     * @return Domaine
     */
    public function addProjet(\Cnes\PhileaBundle\Entity\Projet $projets)
    {
     ...
     * @param \Cnes\PhileaBundle\Entity\Projet $projets
     */
    public function removeProjet(\Cnes\PhileaBundle\Entity\Projet $projets)
    {
